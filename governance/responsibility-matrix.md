...
Authorized by: [Responsible Operator]Action: [specific action]Scope: [specific scope]Target: [specific resource]Limits: [if any]Context: [current session / incident / timestamp]
